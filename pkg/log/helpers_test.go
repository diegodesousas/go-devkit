...
func TestInfofSuccess(t *testing.T) {
	...
	log.Infof(ctx, "info test %d %t %s", 1, true, "param sprintf")
...
func TestDebugfSuccess(t *testing.T) {
	...
	log.Debugf(ctx, "info test %d %t %s", 1, true, "param sprintf")
...
func TestWarnfSuccess(t *testing.T) {
	...
	log.Warnf(ctx, "info test %d %t %s", 1, true, "param sprintf")
...
func TestFatalfSuccess(t *testing.T) {
	...
	log.Fatalf(ctx, "info test %d %t %s", 1, true, "param sprintf")
